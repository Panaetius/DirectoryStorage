...
from .utils import (OMAGIC, TMAGIC, ConfigParser, DirectoryStorageError,
                    FileDoesNotExist, logger, loglevel_INFO, oid2str, z64,
                    z128)
...
class BaseFilesystem(FilesystemPrimitives):
    ...
    def __init__(self):
        ...
        if not self.use_sync:
            logger.log(
                self.ENGINE_NOISE, "sync disabled. Transactions are not durable."
            )
