...
assert (
    _bushy_munge_filename("o0123456789abcdef.0123456789abcdef")
    == "o0/12/34/56/78/9a/bc/def/0123456789abcdef"
)
...
assert (
    _chunky_munge_filename("o0123456789abcdef.0123456789abcdef")
    == "o012/345/678/9ab/cdef.0123456789abcdef"
)
...
assert (
    _lawn_munge_filename("o0123456789abcdef.0123456789abcdef")
    == "o0123456789abcdef/0123456789abcdef"
)
